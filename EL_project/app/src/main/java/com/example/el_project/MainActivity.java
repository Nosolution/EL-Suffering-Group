...
public class MainActivity extends AppCompatActivity {
    ...
    private void initTasks(){
        for(int i=0;i<2;i++){
            Task apple=new Task("Apple",R.drawable.circle,R.drawable.pink);
            taskList.add(apple);
            Task banana=new Task("Banana",R.drawable.circle,R.drawable.red);
            taskList.add(banana);
            Task orange=new Task("Orange",R.drawable.circle,R.drawable.purple);
            taskList.add(orange);
            Task watermelon=new Task("Watermelon",R.drawable.circle,R.drawable.gray);
